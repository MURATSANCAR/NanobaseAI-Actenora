...
/**
 * Optional client-secret token provider for local / WireMock tests only — not for production.
 */
public final class ClientSecretMicrosoftTokenProvider implements MicrosoftTokenProvider {
    ...
    public ClientSecretMicrosoftTokenProvider(ClientSecretCredential credential, InstantClock clock) {
        this(
                credential,
    ...
    ClientSecretMicrosoftTokenProvider(
    ...
    public AccessToken refreshAccessToken() {
        String form = "client_id=" + enc(credential.clientId())
                ...
                + "&client_secret=" + enc(credential.clientSecret())
