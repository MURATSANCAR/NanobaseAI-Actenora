...
public final class PolicyEvaluator {
    ...
    public TenantPolicy resolve(TenantId tenantId, TenantPolicyOverride overrideOrNull) {
    ...
    public void assertWithinQuota(TenantPolicy policy, QuotaDimension dimension, long used, long requested) {
