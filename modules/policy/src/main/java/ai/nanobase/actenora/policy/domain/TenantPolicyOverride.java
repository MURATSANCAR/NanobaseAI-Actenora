...
public final class TenantPolicyOverride {
    ...
    public static Builder builder(UUID tenantId) {
    ...
    public Optional<RetentionPolicy> retention() {
        return retention;
    }

    public Optional<DeliveryPolicy> delivery() {
        return delivery;
    }

    public Optional<ModelAccessPolicy> modelAccess() {
        return modelAccess;
    }

    public Optional<ProcessingSlaPolicy> processingSla() {
        return processingSla;
    }

    public Optional<ConcurrencyPolicy> concurrency() {
        return concurrency;
    }

    public Optional<ExternalParticipantPolicy> externalParticipant() {
        return externalParticipant;
    }

    public Optional<QuotaLimits> quotas() {
        return quotas;
    }
    ...
    public static final class Builder {
        ...
        private Builder(UUID tenantId) {
            this.tenantId = tenantId;
        }

        public Builder retention(RetentionPolicy retention) {
            this.retention = retention;
            return this;
        }

        public Builder delivery(DeliveryPolicy delivery) {
            this.delivery = delivery;
            return this;
        }

        public Builder modelAccess(ModelAccessPolicy modelAccess) {
            this.modelAccess = modelAccess;
            return this;
        }

        public Builder processingSla(ProcessingSlaPolicy processingSla) {
            this.processingSla = processingSla;
            return this;
        }

        public Builder concurrency(ConcurrencyPolicy concurrency) {
            this.concurrency = concurrency;
            return this;
        }

        public Builder externalParticipant(ExternalParticipantPolicy externalParticipant) {
            this.externalParticipant = externalParticipant;
            return this;
        }

        public Builder quotas(QuotaLimits quotas) {
            this.quotas = quotas;
            return this;
        }

        public TenantPolicyOverride build() {
            return new TenantPolicyOverride(this);
        }
    }
}
