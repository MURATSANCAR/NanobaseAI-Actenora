...
public final class ImportantFact {
    ...
    public static ImportantFact createFromMapping(
            TenantId tenantId,
            UUID noteId,
            UUID noteVersionId,
            String text,
    ...
    public static ImportantFact rehydrate(
            UUID id,
            TenantId tenantId,
            UUID noteId,
            UUID noteVersionId,
